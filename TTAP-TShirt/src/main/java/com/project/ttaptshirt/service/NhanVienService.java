...
public class NhanVienService {
    ...
    public List<NhanVien> findByCv(String cv){return repoNhanVien.findByCv_Ten(cv);}

    public List<NhanVien> findByNhanVien(String name){return repoNhanVien.findByHoTenContainingIgnoreCase(name);}
    ...
    public NhanVien updateDiachi(Long nhanVienId, DiaChi diaChi){
        Optional<NhanVien> NhanVienOptional =repoNhanVien.findById(nhanVienId);
    ...
    public Boolean registerNhanVien(NhanVien nhanVien) {
        repoNhanVien.save(nhanVien);
        try {
