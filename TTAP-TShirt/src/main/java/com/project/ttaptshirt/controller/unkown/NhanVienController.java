...
//        List<User> NhanVienList = serNhanVien.findAll();
...
//        mol.addAttribute("nhanVien", new User());
//        return "user/nhanvien/dangky";
//    }
//
//    @PostMapping("/save")
//    public String createNhanVien(@Valid @ModelAttribute User NhanVien, BindingResult result,Model mol){
...
//        User NhanVien = serNhanVien.findById(id)
...
//
//    @PostMapping("/update")
//    public String updateNhanVien(@Valid User NhanVien,BindingResult result, Model mol){
//        if (result.hasErrors()){
//            NhanVien.setId(NhanVien.getId());
//            return "/NhanVien/update";
//        }
//        User existingNhanVien = serNhanVien.findById(NhanVien.getId())
...
//    public String registerNhanVien(@Valid @ModelAttribute User NhanVien,BindingResult result,Model mol) {
//        NhanVien.setNgayTao(LocalDate.now());
//        NhanVien.setNgaySua(LocalDate.now());
...
//            @Valid @ModelAttribute("nhanVien") User nhanVien, BindingResult result,
